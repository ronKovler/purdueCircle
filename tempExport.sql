...
--
-- Host: localhost    Database: purdueCircleDatabase
-- ------------------------------------------------------
...
CREATE TABLE `user_blocked` (
  `user` varchar(64) NOT NULL,
  `blockedUser` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `user_saved_posts` WRITE;
/*!40000 ALTER TABLE `user_saved_posts` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_saved_posts` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-02-15  5:01:29
